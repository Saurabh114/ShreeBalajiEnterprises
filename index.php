...
<!--=========== Header ============-->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      ...
      <div class="d-flex">
        <a href="#about" class="btn-get-started scrollto">Our Products</a>
        <a href="https://www.youtube.com/watch?v=zwv3_mC4XNs&feature=emb_logo" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"><b style="font-size:20px;color:#fff">Corporate Video</b> <i class="icofont-play-alt-2"></i></a>
      </div>
    </div>
  </section><!-- End Hero -->
