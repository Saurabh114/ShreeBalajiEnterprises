        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div id="vagaleSub" class="col-lg-4 col-md-6 portfolio-item filter-wire">
            <div class="portfolio-info">
              ...
              <p>Approx. Price: Rs 505 / Kilogram</p>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-cable">
            ...
            <img src="assets/images/23.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 35 / Meter</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#windingWire">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-copperwire">
            ...
            <img src="assets/images/19.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 590 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#enameled">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-varnish">
            ...
            <img src="assets/images/7.jpg" class="img-fluid" alt="">
              <h4>DR. Varnish</h4>
              <p>Approx. Price: Rs 190 / Litre</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#drvarnish">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-bearing">
            ...
            <img src="assets/images/42.jpg" class="img-fluid" alt="">
              <h4>SKF Bearing</h4>
              <p>Approx. Price: Rs 196 / Piece</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#skfbearing">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-grease">
            ...
            <img src="assets/images/41.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 55 / Milliliter</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#skftube">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-paper">
            ...
            <img src="assets/images/49.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 160 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#paper">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-tube">
            ...
            <img src="assets/images/32.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 200 / Unit</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#rubberTape">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-sleeves">
            ...
            <img src="assets/images/9.jpg" class="img-fluid" alt="">
              <h4>Fiber Sleeves</h4>
              <p>Approx. Price: Rs 250 / Packet</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#sleeves">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-cable">
            ...
            <img src="assets/images/17.jpg" class="img-fluid" alt="">
              <h4>R R Cable</h4>
              <p>Contact us to get Best Price</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#rrcable">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-varnish">
            ...
            <img src="assets/images/8.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 186 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#drbeck">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-copperwire">
            ...
            <img src="assets/images/54.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 510 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#capital">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            ...
            <img src="assets/images/22.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 585 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#rrshram">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-grease">
            ...
            <img src="assets/images/40.jpg" class="img-fluid" alt="">
              <h4>SKF Grease</h4>
              <p>Approx. Price: Rs 209 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#skfgrease">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-cable">
            ...
            <img src="assets/images/18.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 35 / Meter</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#rrflat">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-bearing">
            ...
            <img src="assets/images/20.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 196 / Piece</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#skfball">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-copperwire">
            ...
            <img src="assets/images/52.png" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 525 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#swastik">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            ...
            <img src="assets/images/11.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 575 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#polycab">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-cable">
            ...
            <img src="assets/images/21.jpg" class="img-fluid" alt="">
              ...
              <p>Contact to get Best Price</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#subpump">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-grease">
            ...
            <img src="assets/images/39.jpg" class="img-fluid" alt="">
              ...
              <p>Approx. Price: Rs 209 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#bearinggrease">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-varnish">
            ...
            <img src="assets/images/24.jpg" class="img-fluid" alt="">
              <h4>Jyoti varnish</h4>
              <p>Approx. Price: Rs 175 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#jyoti">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-bearing">
              <div class="portfolio-info">
            <img src="assets/images/36.png" class="img-fluid" alt="">
              <h4>HCH Bearing</h4>
              <p>Contact To get Best Price</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#hch">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            ...
            <img src="assets/images/12.jpg" class="img-fluid" alt="">
              <h4>Polybest Submersible Wires</h4>
              <p>Approx. Price: Rs 598 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#polybest">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-cable">
            ...
            <img src="assets/images/48.jpg" class="img-fluid" alt="">
              ...
              <p>Contact to get Best Price</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#subflat">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            ...
            <img src="assets/images/30.jpg" class="img-fluid" alt="">
              <h4>Mayur Winding Wire</h4>
              <p>Approx. Price: Rs 515 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#mayur">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-copperwire">
            ...
            <img src="assets/images/14.jpg" class="img-fluid" alt="">
              <h4>BIC Copper Wire</h4>
              <p>Approx. Price: Rs 510 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#bic">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            ...
            <img src="assets/images/33.jpg" class="img-fluid" alt="">
              <h4>Mayur Submersible Winding Wire</h4>
              <p>Approx. Price: Rs 505 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#mayursub">
                <p style="color: #0e49b5;">Click to know More </p></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-varnish">
            <div class="portfolio-info">
            <img src="assets/images/37.png" class="img-fluid" alt="">
              <h4>P81 Premier Varnish</h4>
              <p>Approx. Price: Rs 140 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#p81">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            ...
            <img src="assets/images/38.jpg" class="img-fluid" alt="">
              <h4>Polytech Submersible Wire</h4>
              <p>Approx. Price: Rs 505 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#polysub">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            ...
            <img src="assets/images/3.png" class="img-fluid" alt="">
              <h4>R R Winding Wire</h4>
              <p>Approx. Price: Rs 525 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#rrwinding">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            <div class="portfolio-info">
            <img src="assets/images/51.jpg" class="img-fluid" alt="">
              <h4>Submersible Pump Winding Wire</h4>
              <p>Approx. Price: Rs 555 / Piece</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#pumpwimding">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-wire">
            ...
            <img src="assets/images/47.jpg" class="img-fluid" alt="">
              <h4>R R Submersible Winding Wire  </h4>
              <p>Approx. Price: Rs 535 / Kilogram</p>
              <a type="button" class="btn-get-started scrollto" data-toggle="modal" data-target="#rrsub">
                <p style="color: #0e49b5;">Click to know More </p>
              </a>
            </div>
          </div>
